...
export const PROJECTS: ProjectData[] = [
  ...
  },
  {
    ...
    season: "Summer 2026",
    description:
      "A comprehensive construction material ordering app making procurement fast, transparent, and effortless.",
    role: "Lead Product Designer",
    projectType: "UX/UI Case Study",
    layers: [
      "/projects/buildo/1.png?pos=center",
      "/projects/buildo/2.png",
      "/projects/buildo/3.png",
      "/projects/buildo/4.png",
    ],
    layerType: "mixed",
    overview:
      "Designed to streamline how contractors and homeowners purchase materials, Buildo enables efficient ordering, transparent pricing, and real-time delivery visibility.",
    roleDescription:
      "I designed the end-to-end UX/UI, mapping the fragmented user journey, identifying key pain points, and creating a unified mobile platform for material procurement.",
    researchPlan: {
      subtitle: "Understanding procurement workflows",
      stats: [
        { value: "82%", label: "Pricing Issues" },
        { value: "70%", label: "Delivery Delays" },
        { value: "3/5", label: "Need Live Tracking" },
      ],
      methods: ["User Interviews", "Field Observation", "Surveys", "Empathy Mapping"],
    },
    keyScreens: [
      "/projects/buildo/home.png",
      "/projects/buildo/product.png",
    ],
    highlights: [
      "Real-time Tracking",
      "Multi-site Delivery",
