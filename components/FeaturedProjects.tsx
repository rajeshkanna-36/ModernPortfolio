...
export default function FeaturedProjects() {
  ...
  return (
    <motion.section 
      ...
      className="relative w-full max-w-[1440px] mx-auto px-4 md:px-8 pt-12 pb-32 bg-white z-0 origin-bottom" 
      id="work"
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-32 lg:gap-x-6 lg:gap-y-40 mt-12 pb-12 w-full">
